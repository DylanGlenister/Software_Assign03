...
from ..models.employee import EmployeeAccount, TagCreate, TagResponse, ImageCreate, ProductTagResponse, ProductImageResponse 
...
employee_route = APIRouter(
    prefix=SETTINGS.api_path + "/employee",
    tags=["employee"]
)
...
def get_employee_account(account_data: dict = Depends(get_account_data)) -> EmployeeAccount:
...
def create_product_route(
    ...
    """
    return account.create_product_in_catalogue(product_to_create, catalogue_service)
...
def update_product_route(
    ...
    Logic is handled by the EmployeeAccount.
    """
    return account.update_product_in_catalogue(product_id, product_to_update, catalogue_service)

@employee_route.get(
    "/orders",
    summary="Returns all the orders in the system"
)
def get_all_orders_route(account: EmployeeAccount = Depends(get_employee_account)):
    """
